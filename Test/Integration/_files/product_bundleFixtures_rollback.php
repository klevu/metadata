...
if ($moduleManager->isEnabled('Magento_InventoryCatalog')) {
    ...
    $sourceItemRepository = Bootstrap::getObjectManager()->get(\Magento\InventoryApi\Api\SourceItemRepositoryInterface::class);
    /** @var \Magento\InventoryApi\Api\SourceItemsDeleteInterface $sourceItemsDelete */
    $sourceItemsDelete = Bootstrap::getObjectManager()->get(\Magento\InventoryApi\Api\SourceItemsDeleteInterface::class);
